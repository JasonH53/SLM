...
public class RenderUtils {
    ...
    public static void drawLines(ArrayList<Vec3> poses, final float thickness, final float partialTicks) {
        ...
        for (final Vec3 pos : poses) {
            ...
            worldrenderer.pos(pos.xCoord + 0.5, pos.yCoord + 0.5, pos.zCoord + 0.5).color((i >> 16 & 0xFF) / 255.0f, (i >> 8 & 0xFF) / 255.0f, (i & 0xFF) / 255.0f, (i >> 24 & 0xFF) / 255.0f).endVertex();
        }
    ...
    public static void drawBlockBox(BlockPos blockPos, int color, float partialTicks) {
        drawBlockBox(blockPos, new Color((color >> 24 & 0xFF) / 255.0f, (color >> 16 & 0xFF) / 255.0f, (color >> 8 & 0xFF) / 255.0f), partialTicks);
    }

    public static void drawBlockBox(final BlockPos blockPos, final Color color, float partialTicks) {
